...
<div class="main">
    ...
    <thead class="thead-dark">
    <p style="font-size:50px; text-align:center;">Laporan Penjualan</p><hr>
    <tr>
    ...
    <thead>
      <tbody>
        ...
        <td>ZX3000</td>
        <td>19 apr 2019</td>
        <td><a  href="detaillaporanpenjualan.php"><button type="button" class="btn btn-outline-primary" style="font-size:20px">Detail</button></a>
        </td>
        </tr>
