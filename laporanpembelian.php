...
<div class="main">
    ...
    <thead class="thead-dark">
    <p style="font-size:50px; text-align:center;">Laporan Pembelian</p><hr>
    <tr>
    ...
    <thead>
      <tbody>
        ...
        <td>A2000</td>
        <td>19 apr 2019</td>
        <td><a  href="Detaillaporanpembelian.php"><button type="button" class="btn btn-outline-primary" style="font-size:20px">Detail</button></a>
        </td>
        </tr>
